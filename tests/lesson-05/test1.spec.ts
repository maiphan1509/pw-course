...
test("Register Page Test", async ({ page }) => {
  await test.step("1. Go to the registration page", async () => {
    await page.goto("https://material.playwrightvn.com/");
    await page.click("text=Bài học 1: Register Page");
  });

  await test.step("2. Fill in the registration form", async () => {
  ...
  test.step("3. Submit the form and verify the result", async () => {
